...
public class ChangeTimeMethodsTransformer extends CachingClassFileTransformer {
    ...
    public ChangeTimeMethodsTransformer(Configuration configuration, Log log, String agentVersion) {
